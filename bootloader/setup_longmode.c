...
void identity_map_1gb()
{
    ...
    for (int i = 0; i < 512; i++) { 
        pud[i] = ((i*0x40000000)& 0xFFFFFFFFFF000) |0b10000011;// 3;
    }
    /*
    pud[0] = (0& 0xFFFFFFFFFF000) |0b10000011;// 3;
    pud[2] = ((2*0x40000000)& 0xFFFFFFFFFF000) |0b10000011;// 3;
    pud[3] = ((3*0x40000000)& 0xFFFFFFFFFF000) |0b10000011;// 3;
    pud[4] = ((4*0x40000000)& 0xFFFFFFFFFF000) |0b10000011;// 3;
    pud[5] = ((5*0x40000000)& 0xFFFFFFFFFF000) |0b10000011;// 3;
    pud[6] = ((6*0x40000000)& 0xFFFFFFFFFF000) |0b10000011;// 3;
    pud[7] = ((7*0x40000000)& 0xFFFFFFFFFF000) |0b10000011;// 3;
    */
